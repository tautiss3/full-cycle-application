...
(window.dhtmlXScheduler = window.scheduler = { version: "5.1.6" }),
  ...
  (function() {
    ...
    function n(e, r, s) {
      ...
      return (
        "top" == e.position ? (n.style.top = "-3px") : (n.style.top = o + "px"),
        (n.style.left = d + "px"),
        (n.onkeydown = t),
...
(dataProcessor.prototype = {
  ...
  _errorResponse: function(e, t) {
    return (
      this.obj &&
        this.obj.callEvent &&
        this.obj.callEvent("onSaveError", [t, e.xmlDoc]),
      this.cleanUpdate(t)
    );
  },
  ...
  (function() {
    ...
    scheduler._waiAria = {
      ...
      _eventCommonAttr: function(t, i) {
        i.setAttribute(
          "aria-label",
          e(scheduler.templates.event_text(t.start_date, t.end_date, t))
        ),
  ...
  (scheduler._click = {
    ...
    dhx_cal_next_button: function(e, t) {
      scheduler.setCurrentView(
        scheduler.date.add(
          scheduler.date[scheduler._mode + "_start"](new Date(scheduler._date)),
          t || 1,
          scheduler._mode
        )
      );
  ...
  (scheduler.addEventNow = function(e, t, i) {
    ...
    e ||
      (e =
        r.start_date || Math.round(scheduler._currentDate().valueOf() / s) * s);
    var a = new Date(e);
    if (!t) {
      ...
      return (
        ...
        (e.y =
          Math.max(
            0,
            Math.ceil(
              (60 * e.y) / (this.config.time_step * this.config.hour_size_px)
            ) - 1
          ) +
  ...
  (scheduler._correct_drag_start_date = function(e) {
    ...
    return (
      (t._start_correction || t._end_correction) &&
        (i =
          60 * (t.last_hour || 0) - (60 * e.getHours() + e.getMinutes()) || 1),
  ...
  (scheduler._on_mouse_move = function(e) {
    if (this._drag_mode) {
      ...
      if (this._is_pos_changed(this._drag_pos, t)) {
        ...
        if (
          (scheduler.matrix && (o = scheduler.matrix[scheduler._mode]),
          ...
          (i =
            ...
            t._ignores && this.config.preserve_length && this._table_view
              ...
              : (r = l.end_date.valueOf() - (l.start_date.valueOf() - i));
        else {
          if (
            ((i = l.start_date.valueOf()),
            (r = l.end_date.valueOf()),
            this._table_view)
          ) {
            var h =
              this._min_date.valueOf() +
            ...
            if ("month" == this._mode)
              if (((h = this._correct_shift(h, !1)), this._drag_from_start)) {
                var _ = 864e5;
                h <= scheduler.date.date_part(new Date(r + _ - 1)).valueOf() &&
                  (i = h - _);
              } else r = h;
            else
        ...
        if (
          ...
          if (
            +l.start_date < +scheduler._min_date ||
            +l.end_date > +scheduler._max_date
          )
            (v = new Date(l.start_date)), (r = new Date(l.end_date));
          else {
            var m = r - v;
            +v < +scheduler._min_date
              ? ((v = new Date(scheduler._min_date)),
                t._ignores && this.config.preserve_length && this._table_view
                  ? ((v = new Date(scheduler._correct_drag_start_date(v))),
                    o._start_correction &&
                      (v = new Date(v.valueOf() + o._start_correction)),
                    (r = new Date(
                      1 * v +
              ...
              : ((r = new Date(scheduler._max_date)),
                t._ignores && this.config.preserve_length && this._table_view
                  ? (o._end_correction &&
                      (r = new Date(r.valueOf() - o._end_correction)),
                    (r = new Date(
                      1 * r - this._get_fictional_event_length(r, 0, o, !0)
                    )),
                    (v = new Date(
                      1 * r -
                        this._get_fictional_event_length(
                    ...
                    this._ignores_detected &&
                      ((v = scheduler.date.add(v, o.x_step, o.x_unit)),
                      (r = new Date(
                        1 * r - this._get_fictional_event_length(r, 0, o, !0)
                      )),
                      (r = scheduler.date.add(r, o.x_step, o.x_unit))))
                  : (v = new Date(+r - m)));
          }
          var f = new Date(r - 1);
        }
      ...
      if (this._drag_mode && this._drag_id) {
        ...
        if (
          ...
          (this._drag_event._dhx_changed ||
            !this._drag_event.start_date ||
            s.start_date.valueOf() != this._drag_event.start_date.valueOf() ||
            s.end_date.valueOf() != this._drag_event.end_date.valueOf())
        ) {
          var a = "new-size" == this._drag_mode;
          if (
            this.callEvent("onBeforeEventChanged", [s, e, a, this._drag_event])
          )
            if (
      ...
      for (var i = this._els[e[t]], r = 0; i && r < i.length; r++) {
        ...
        s && (a = this.locale.labels[s] || a),
          "dhx_cal_next_button" == e[t]
            ...
            : "dhx_cal_prev_button" == e[t] && (a = this.locale.labels.prev),
  ...
  (scheduler.updateView = function(e, t) {
    ...
    this.update_view(),
      "number" == typeof o && (this._els[i][0].scrollTop = o),
      "number" == typeof n &&
        this._els[d] &&
        this._els[d][0] &&
  ...
  (scheduler._render_x_header = function(e, t, i, r, s) {
    ...
    (a.className = "dhx_scale_bar"),
      this.templates[this._mode + "_scalex_class"] &&
        (a.className += " " + this.templates[this._mode + "_scalex_class"](i));
  ...
  (scheduler._render_scales = function(e, t) {
    ...
    for (var l = 0; d > l; l++) {
      if (
        (this._ignores[l] || this._render_x_header(l, o, n, e),
        !this._table_view)
      ) {
  ...
  (scheduler._reset_scale = function() {
    if (this.templates[this._mode + "_date"]) {
      ...
      if (
        ((this._els.dhx_cal_date[0].innerHTML = o),
        this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], o),
        (this._max_date = d),
        ...
        var l = "dhx_multi_day";
        this._els[l] &&
          (this._els[l][0].parentNode.removeChild(this._els[l][0]),
          (this._els[l] = null));
        ...
        (c.className = l),
          ...
          this.set_xy(
            c,
            Math.max(
              this._colsS[this._colsS.col_length] + this.xy.scroll_width - 2,
              0
            ),
            0,
            0,
        ...
        (u.className = l + "_icon"),
          ...
          c.appendChild(u),
          (this._els[l] = [c, u]),
          (this._els[l][0].onclick = this._click.dhx_cal_data);
      }
    }
  }),
  (scheduler._reset_hours_scale = function(e, t, i) {
    ...
    for (
      ...
      (n.innerHTML = o),
        this._waiAria.hourScaleAttr(n, o),
        r.appendChild(n),
  ...
  (scheduler._process_ignores = function(e, t, i, r, s) {
    ...
    if (a)
      for (var n = new Date(e), d = 0; t > d; d++)
        a(n) &&
          ((this._ignores_detected += 1), (this._ignores[d] = !0), s && t++),
          (n = scheduler.date.add(n, r, i)),
          scheduler.date[i + "_start"] && (n = scheduler.date[i + "_start"](n));
  }),
  (scheduler._render_month_scale = function(e, t, i, r) {
    ...
    this.date.date_part(d),
      ...
      (r = r || Math.ceil(Math.round((a.valueOf() - i.valueOf()) / 864e5) / 7));
    for (var o = [], l = 0; 7 >= l; l++) {
    ...
    for (var g = [], l = 0; r > l; l++) {
      ...
      u.appendChild(f);
      for (
        var v = Math.max(s(l) - scheduler.xy.month_head_height, 0), m = 0;
        7 > m;
        m++
      ) {
        ...
        t > i
          ...
          : i >= a
          ? (b = "dhx_after")
          : i.valueOf() == d.valueOf() && (b = "dhx_now"),
          this._ignores_detected &&
            this._ignores[m] &&
            (b += " dhx_scale_ignore"),
          (p.className = b + " " + this.templates.month_date_class(i, d));
        var x = "dhx_month_body",
          y = "dhx_month_head";
        if (
          (0 === m &&
            this.config.left_border &&
            ((x += " dhx_month_body_border"), (y += " dhx_month_head_border")),
  ...
  (scheduler._reset_month_scale = function(e, t, i, r) {
    ...
    this.date.date_part(a),
      this.date.date_part(i),
      (r = r || Math.ceil(Math.round((s.valueOf() - i.valueOf()) / 864e5) / 7));
  ...
  (scheduler._get_date_from_pos = function(e) {
    var t =
      this._min_date.valueOf() +
      6e4 *
        (e.y * this.config.time_step + 24 * (this._table_view ? 0 : e.x) * 60);
  ...
  (scheduler._get_fictional_event_length = function(e, t, i, r) {
    ...
    for (
      i.render
        ? ((c = this._get_date_index(i, s)), (l = this._get_date_index(i, h)))
        : (l = Math.round(t / 60 / 60 / 1e3 / 24));
      l * a >= c * a;
          ...
          (o.onreadystatechange = function() {
            if (4 == o.readyState || (l && 3 == o.readyState)) {
              if (
                ...
                !d.callEvent("onAjaxError", [o])
              )
                return;
              window.setTimeout(function() {
                "function" == typeof s &&
                  s.apply(window, [{ xmlDoc: o, filePath: t }]),
                  a &&
    ...
    str_to_date: function(e, t) {
      for (
        ...
        switch (r[s]) {
          ...
          case "%M":
            i +=
              "set[1]=scheduler.locale.date.month_short_hash[temp[" +
              s +
              "]]||0;";
            break;
          case "%F":
            i +=
              "set[1]=scheduler.locale.date.month_full_hash[temp[" +
              s +
              "]]||0;";
        }
  ...
  (scheduler._render_month_link = function(e) {
    for (
      ...
      (l.onclick = function(e) {
        ...
        (l.style.left = d.x + "px"),
        (l.style.width = o + "px"),
        (l.innerHTML = scheduler.templates.month_events_link(a, n)),
  ...
  (scheduler.render_data = function(e, t) {
    ...
    for (var i = {}, r = 0; r < e.length; r++)
      if (this._table_view)
        if ("month" != scheduler._mode) this.render_event_bar(e[r]);
        else {
          var s = scheduler.config.max_month_events;
          s !== 1 * s || e[r]._sorder < s
            ? this.render_event_bar(e[r])
            : void 0 !== s &&
              e[r]._sorder == s &&
              scheduler._render_month_link(e[r]);
        }
      else {
        var a = e[r],
          n = scheduler.locate_holder(a._sday);
        if (!n) continue;
        i[a._sday] ||
          (i[a._sday] = {
            real: n,
      ...
      if (t) this._colsS.heights = r;
        ...
        if (n.rows) {
          for (var d = 0; d < n.rows.length; d++) {
            ...
            s[d] =
              (s[d - 1] || 0) +
              scheduler._get_first_visible_cell(o).offsetHeight;
          }
          if (
            (s.unshift(0),
          ...
          (b.style.height = m),
            (b.style.visibility = -1 == s[0] ? "hidden" : "visible"),
            (b.className = s[0]
              ? "dhx_multi_day_icon"
  ...
  (scheduler._pre_render_events_line = function(e, t) {
    ...
    for (var s = 0; s < e.length; s++) {
      ...
      if (((a._sday = this._get_event_sday(a)), this._ignores[a._sday]))
        ...
        (o < this.config.first_hour || l >= this.config.last_hour) &&
          (r.push(a),
          (e[s] = a = this._copy_event(a)),
          o < this.config.first_hour &&
          ...
          a.start_date > a.end_date || o == this.config.last_hour) &&
          (e.splice(s, 1), s--);
      }
    }
    if (!t) {
  ...
  (scheduler._is_any_multiday_cell_visible = function(e, t, i) {
    for (var r = this._cols.length, s = !1, a = e, n = !0; t > a; ) {
      n = !1;
      var d = this.locate_holder_day(a, !1, i),
        o = d % r;
      if (!this._ignores[o]) {
        s = !0;
        break;
    ...
    for (
      ...
      if (((l._sday = g % n), !this._ignores[l._sday] || !l._timed)) {
        ...
        (l._eday = f % n || n),
          (l._length = f - g),
          (l._sweek = Math.floor(
            (this._correct_shift(c.valueOf(), 1) - this._min_date.valueOf()) /
              (864e5 * n)
          ));
        ...
        if (v) {
          ...
          if (((l._sorder && t) || (l._sorder = m), l._sday + l._length <= n))
            (i = null),
              r.push(l),
              (p[m] = l),
              (a[l._sweek] = p.length - 1),
            ...
            (b.id = l.id),
              ...
              (b._sweek = l._sweek),
              (b._sorder = l._sorder),
              (b.end_date = this.date.add(c, b._length, "day")),
              (b._first_chunk = _.first_chunk),
  ...
  (scheduler.render_event = function(e, t, i) {
    var r = scheduler.xy.menu_width,
      s = this.config.use_select_menu_space ? 0 : r;
    if (!(e._sday < 0)) {
      ...
      if (a) {
        ...
        if (
          (this._waiAria.eventAttr(e, v),
          this._rendered.push(v),
          t.appendChild(v),
          (c = c + parseInt(a.style.left, 10) + s),
          this._edit_id == e.id)
        ) {
          (v.style.zIndex = 1),
            (_ = Math.max(_ - 4, scheduler.xy.editor_width)),
            (v = document.createElement("div")),
            v.setAttribute("event_id", e.id),
            this._waiAria.eventAttr(e, v),
            this.set_xy(
              v,
              _,
              o - 20,
              c,
              d + (scheduler.xy.event_header_height || 14)
            ),
            (v.className = "dhx_cal_event dhx_cal_editor"),
            e.color && (v.style.backgroundColor = e.color);
          var m = scheduler.templates.event_class(e.start_date, e.end_date, e);
          m && (v.className += " " + m);
          var p = document.createElement("div");
          this.set_xy(p, _ - 6, o - 26),
            (p.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;"),
            v.appendChild(p),
            this._els.dhx_cal_data[0].appendChild(v),
            this._rendered.push(v),
            (p.innerHTML =
              "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>"),
            this._quirks7 && (p.firstChild.style.height = o - 12 + "px"),
            (this._editor = p.firstChild),
            ...
            scheduler._focus(p.firstChild, !0),
        ...
        if (0 !== this.xy.menu_width && this._select_id == e.id) {
          ...
          for (
            var b,
              ...
              y = "",
              w = e.color ? "background-color: " + e.color + ";" : "",
              D = e.textColor ? "color: " + e.textColor + ";" : "",
              E = 0;
            E < x.length;
            E++
          )
            (b = this._waiAria.eventMenuAttrString(x[E])),
              (y +=
                ...
                D +
                "' title='" +
                this.locale.labels[x[E]] +
                "'" +
                b +
                "></div>");
          var A = this._render_v_bar(
            e,
            c - r + 1,
            d,
            r,
            20 * x.length + 26 - 2,
            "",
            "<div style='" + w + D + "' class='dhx_menu_head'></div>",
            y,
            !0
          );
          (A.style.left = c - r + 1),
            this._els.dhx_cal_data[0].appendChild(A),
  ...
  (scheduler._render_v_bar = function(e, t, i, r, s, a, n, d, o) {
    ...
    return (
      (o || e._drag_resize === !1) && (k = "dhx_resize_denied " + k),
      (A +=
        '<div class="' +
        k +
        '" style=" width:' +
  ...
  (scheduler.render_event_bar = function(e) {
    ...
    if (a) {
      ...
      (!e._timed || d) && (u = "dhx_cal_event_line"),
        ...
        _ &&
          (n += "<div class='dhx_event_resize dhx_event_resize_start'></div>"),
        c && (n += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
  ...
  (scheduler.showEvent = function(e, t) {
    var i =
      "number" == typeof e || "string" == typeof e ? scheduler.getEvent(e) : e;
    if (
      ((t = t || scheduler._mode),
      i &&
  ...
  (scheduler._load = function(e, t) {
    if ((e = e || this._load_url)) {
      ...
      if (((t = t || this._date), this._load_mode)) {
        ...
        if (t >= i) return !1;
        for (
          scheduler.$ajax.get(e + "&from=" + r(t) + "&to=" + r(i), function(e) {
            scheduler.on_load(e);
          });
          i > t;
  ...
  (scheduler.json.parse = function(data) {
    ...
    for (var key in collections)
      if (collections.hasOwnProperty(key)) {
        ...
        arr || (scheduler.serverList[key] = arr = []),
  ...
  (scheduler._magic_parser = function(e) {
    ...
    if (
      (e.xmlDoc.responseXML ||
        (e.xmlDoc.responseXML = scheduler.$ajax.parse(e.xmlDoc.responseText)),
    ...
    for (
      ...
      for (
        var d = scheduler.$ajax.xpath(".//item", r[s]), o = 0;
        o < d.length;
        o++
      ) {
        for (
  ...
  (scheduler.ical = {
    ...
    parse_param: function(e, t) {
      ...
      if (-1 != i) {
        ...
        "summary" == r
          ...
          : "dtend" == r && ((r = "end_date"), (s = this.parse_date(s, 0, 0))),
          (t[r] = s);
      }
    },
    parse_date: function(e, t, i) {
      ...
      var s = r[0].substr(0, 4),
        ...
        n = r[0].substr(6, 2);
      return scheduler.config.server_utc && !r[1]
        ? new Date(Date.UTC(s, a, n, t, i))
        : new Date(s, a, n, t, i);
    },
    ...
    if (e) {
      ...
      t
        ...
        document.documentElement.scrollWidth > document.body.offsetWidth
          ? (e.style.left =
              Math.round(i + (document.body.offsetWidth - e.offsetWidth) / 2) +
              "px")
          : (e.style.left =
  ...
  (scheduler.save_lightbox = function() {
    ...
    (!this.checkEvent("onEventSave") ||
      this.callEvent("onEventSave", [this._lightbox_id, e, this._new_event])) &&
  ...
  (scheduler._move_while_dnd = function(e) {
    if (scheduler._dnd_start_lb) {
      ...
      (t.style.top =
        ...
        (t.style.left =
          scheduler._lb_start[0] + i[0] - scheduler._dnd_start_lb[0] + "px");
    }
  }),
  (scheduler._ready_to_dnd = function(e) {
    ...
    (scheduler._lb_start = [
      ...
      (scheduler._dnd_start_lb =
        e && e.target ? [e.pageX, e.pageY] : [event.clientX, event.clientY]);
  }),
  ...
  (scheduler._touch_events = function(e, t, i) {
    ...
    function s(e, t, i, r) {
      ...
      var n = Math.abs(e.pageY - t.pageY),
        d = Math.abs(e.pageX - t.pageX);
      return r > n && d > i && (!n || d / n > 3)
        ? (e.pageX > t.pageX
    ...
    r(document.body, e[0], function(e) {
        ...
        if (r) {
          ...
          if (((o = t(e)), c))
            return o
              ? void (
                  (d.target != o.target ||
                    Math.abs(d.pageX - o.pageX) > 5 ||
                    Math.abs(d.pageY - o.pageY) > 5) &&
                  ((_ = !0), clearTimeout(l))
                )
              : void (_ = !0);
        }
            ...
            (l = setTimeout(function() {
              ...
              e && -1 != t.indexOf("dhx_body") && (e = e.previousSibling),
                ...
                scheduler._drag_mode &&
                  ...
                  scheduler.for_rendered(scheduler._drag_id, function(e, t) {
                    (e.style.display = "none"),
                      scheduler._rendered.splice(t, 1);
                  }),
      ...
      r(this._els.dhx_cal_data[0], e[2], function(e) {
        return i(e)
          ? void 0
          : (!h && s(d, o, 200, 100) && (scheduler._block_next_stop = !0),
            h &&
      ...
      if (scheduler._drag_id && !e) {
        ...
        r &&
          (i =
            "<div>" +
            (r._timed
              ? scheduler.templates.event_header(r.start_date, r.end_date, r)
              : scheduler.templates.day_date(r.start_date, r.end_date, r)) +
            "</div>");
      }
      "create" == scheduler._drag_mode || "new-size" == scheduler._drag_mode
        ? (t.innerHTML =
            (scheduler.locale.labels.drag_to_create || "Drag to create") + i)
        : (t.innerHTML =
            ...
            ((scheduler.templates.month_day = function(i) {
              if ("month" == this._mode) {
                ...
                return (
                  1 == i.getDate() &&
                    (r =
                      scheduler.locale.date.month_full[i.getMonth()] + " " + r),
                  +i == +scheduler.date.date_part(this._currentDate()) &&
                    (r =
                      scheduler.locale.labels.dhx_cal_today_button + " " + r),
                  r
                );
              }
            ...
            for (var d = 0; d < i.length; d++) {
              ...
              if (l) {
                switch (((o.style.right = "auto"), l)) {
                  ...
                  case "month_tab":
                    (o.style.left = a[2] + "px"),
                      (o.className += " dhx_cal_tab_last");
                    break;
                  default:
                    (o.style.left = s + "px"),
                      (o.className += " dhx_cal_tab_standalone"),
                      (s = s + n + o.offsetWidth);
                }
                o.className += " " + l;
              } else
                0 === (o.className || "").indexOf("dhx_minical_icon") &&
                  o.parentNode == scheduler._els.dhx_cal_navline[0] &&
                  (r = o);
            }
            r && (r.style.left = s + "px");
          }
    ...
    !(function(e) {
      ...
      e.fn.dhx_scheduler = function(i) {
          ...
          return (
            this.each(function() {
              if (
                this &&
                this.getAttribute &&
                !this.getAttribute("dhxscheduler")
              ) {
                ...
                this.getElementsByTagName("div").length ||
                  ...
                  scheduler.init(
                    ...
                    scheduler.config.mode
                  ),
                  i.data && scheduler.parse(i.data),
                  r.push(scheduler);
              }
            }),
            1 === r.length ? r[0] : r
        ...
        return t[i]
          ? t[i].apply(this, [])
          : void e.error(
              "Method " + i + " does not exist on jQuery.dhx_scheduler"
            );
      };
    })(jQuery),
  (function() {
